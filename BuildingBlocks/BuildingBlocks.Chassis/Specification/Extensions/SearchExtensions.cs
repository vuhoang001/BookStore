...
namespace BuildingBlocks.Chassis.Specification.Extensions;
...
public static class SearchExtension
{
        ...
        where T : class
    {
        ...
        return source.Where(
            Expression.Lambda<Func<T, bool>>(likeExpr, param)
        );
    }
        ...
        where T : class
    {
        ...
        foreach (var searchExpression in searchExpressions)
        {
            ...
            {
                visitor ??= new ParameterReplacerVisitor(
                    searchExpression.Selector.Parameters[0],
                    mainParam);
        ...
        return combinedExpr is null || mainParam is null
            ? source
            : source.Where(
                Expression.Lambda<Func<T, bool>>(combinedExpr, mainParam)
            );
    }
